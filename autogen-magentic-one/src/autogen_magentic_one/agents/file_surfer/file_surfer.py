...
from autogen_core.components import default_subscription, FunctionCall
...
from ._tools import TOOL_FIND_NEXT, TOOL_FIND_ON_PAGE_CTRL_F, TOOL_OPEN_LOCAL_FILE, TOOL_PAGE_DOWN, TOOL_PAGE_UP, TOOL_EXTRACT_ZIP
...
class FileSurfer(BaseWorker):
    ...
    def __init__(
        ...
        self._tools = [TOOL_OPEN_LOCAL_FILE, TOOL_PAGE_UP, TOOL_PAGE_DOWN, TOOL_FIND_ON_PAGE_CTRL_F, TOOL_FIND_NEXT, TOOL_EXTRACT_ZIP]
        ...
        if isinstance(response, str):
            ...
            for function_call in function_calls:
                ...
                if tool_name == "open_local_file":
                    ...
                    self.extract_zip(arguments["zip_path"], arguments["extract_to"])
    ...
    def extract_zip(self, zip_path: str, extract_to: str) -> str:
        ...
        try:
            with zipfile.ZipFile(zip_path, 'r') as zip_ref:
                ...
                return f"Extraction complete. Files extracted to '{extract_to}'."
